          ...
          {filteredScripts.length === 0 ? (
            ...
            <TabsContent value="discord">
              <div className="grid gap-6">
                {/* Discord Link Status */}
                <Card className={discordLink ? "border-green-500/30" : "border-primary/20"}>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="flex items-center gap-2">
                        ...
                        <CardDescription>
                          {discordLink ? "Your Discord account is linked" : "Link your Discord to use bot commands"}
                        </CardDescription>
                      </div>
                      {discordLink && (
                    ...
                    {discordLink ? (
                      ...
                      <div className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                          Link your Discord account to manage script whitelists and blacklists directly from Discord using slash commands.
                        </p>
                        <Button onClick={() => navigate("/link-discord")} variant="hero" className="w-full">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>What you can do with the DefendLua Discord bot</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="font-medium mb-2">📋 Script Management</h4>
                        <p className="text-sm text-muted-foreground">
                          View all your protected scripts and their status directly in Discord.
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="font-medium mb-2">✅ Whitelist HWIDs</h4>
                        <p className="text-sm text-muted-foreground">
                          Quickly add or remove HWIDs from your script whitelists.
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="font-medium mb-2">🚫 Blacklist HWIDs</h4>
                        <p className="text-sm text-muted-foreground">
                          Block unwanted users by adding them to your blacklist.
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="font-medium mb-2">⚡ Instant Updates</h4>
                        <p className="text-sm text-muted-foreground">
                          Changes made through Discord take effect immediately.
                        </p>
                      </div>
                    </div>
                  </CardContent>
